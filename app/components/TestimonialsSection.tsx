...
const reviews = [
  {
    ...
    text: "RR Athleisure jerseys are absolutely incredible. The fabric is breathable, the fit is perfect, and I've shaved 2 minutes off my PB wearing them. This is next-level sportswear.",
  ...
  },
  {
    ...
    text: "I've tried every brand out there. Nothing comes close to RR Athleisure's leggings. They stay in place through the heaviest lifts, look incredible, and the quality is unreal.",
  ...
  },
  {
    ...
    text: "Ordered jerseys for our entire squad. The quality, the delivery speed, the customisation — every single player was impressed. RR Athleisure is now our official kit partner.",
