        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-xs">
              ...
              for performance, designed for champions.
            </p>
            {/* Social */}
            <div className="flex gap-3">
              {socialLinks.map((s) => (
                <Link
                  ...
                  href={s.href}
                  aria-label={s.name}
                  className="w-9 h-9 bg-[#1a1a1a] hover:bg-red-600 text-gray-400 hover:text-white flex items-center justify-center transition-all duration-200"
                >
                  {s.icon}
                </Link>
              ))}
          ...
          <div className="flex flex-wrap justify-center gap-x-5 gap-y-2">
            {["Privacy", "Terms", "Cookies"].map((item) => (
              <Link
                key={item}
                href="#"
                className="text-gray-600 hover:text-gray-400 text-xs uppercase tracking-widest transition-colors duration-200"
              >
                {item}
              </Link>
            ))}
